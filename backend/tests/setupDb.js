// Shared helper that creates a fresh in-memory sql.js Database
// and runs the full schema against it.
...
const SCHEMA_SQL = `
  ...
  CREATE INDEX IF NOT EXISTS idx_movie_similarities_movie_id ON movie_similarities(movie_id);
  CREATE INDEX IF NOT EXISTS idx_users_username ON users(username);
  CREATE INDEX IF NOT EXISTS idx_movies_title ON movies(title);
  CREATE INDEX IF NOT EXISTS idx_ratings_user ON ratings(user_id, movie_id);
  CREATE INDEX IF NOT EXISTS idx_favorites_user ON favorites(user_id, movie_id);
